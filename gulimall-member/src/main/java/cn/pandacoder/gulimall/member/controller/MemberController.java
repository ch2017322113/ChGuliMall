package cn.pandacoder.gulimall.member.controller;

import java.util.Arrays;
import java.util.Map;

//import org.apache.shiro.authz.annotation.RequiresPermissions;
import cn.pandacoder.gulimall.member.feign.CoupenFeignService;
...
import cn.pandacoder.gulimall.member.service.MemberService;
...
public class MemberController {
    ...
    public R test() {
        ...
        return memberCoupon.ok().put("member", memberEntity)
